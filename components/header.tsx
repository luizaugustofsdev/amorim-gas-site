      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#home" className="flex items-center gap-2">
            ...
            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center p-1 shadow-md ring-1 ring-[#0A8F42]/20">
              <Image
            ...
            <div className="hidden md:block">
              <div className="text-[#05612C] font-bold text-lg leading-tight">
                AMORIM GÁS
              </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="tel:+5561998455466" className="flex items-center gap-2 text-[#0A8F42]">
          ...
          >
            {isMenuOpen ? (
              <X className="w-6 h-6 text-[#0A8F42]" />
            ) : (
              <Menu className="w-6 h-6 text-[#0A8F42]" />
            )}
          </button>
