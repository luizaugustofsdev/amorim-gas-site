        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-[#05612C] font-bold text-lg">AG</span>
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#home" className="text-[#54D68B] hover:text-white transition-colors">
                  Início
                </a>
              </li>
              <li>
                <a href="#about" className="text-[#54D68B] hover:text-white transition-colors">
                  Sobre
                </a>
              </li>
              <li>
                <a href="#products" className="text-[#54D68B] hover:text-white transition-colors">
                  Produtos
                </a>
              </li>
              <li>
                <a href="#pricing" className="text-[#54D68B] hover:text-white transition-colors">
                  Preços
                </a>
              </li>
              <li>
                <a href="#contact" className="text-[#54D68B] hover:text-white transition-colors">
                  Contato
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-[#54D68B] shrink-0 mt-1" />
